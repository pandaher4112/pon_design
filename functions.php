...
function add_scripts() {
  ...
  wp_enqueue_script( 'swiper',get_template_directory_uri() . '/js/swiper/swiper-bundle.min.js', array( 'jquery' ), '20220901', true );
...
function add_files() {
  ...
  wp_enqueue_style( 'swiper',get_template_directory_uri() . '/css/swiper-bundle.min.css', "", '20220901' );
